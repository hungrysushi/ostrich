...
public:
        ...
        uint16_t Read(RegisterType registerType) {
            switch(registerType) {
                ...
                case RegisterType::F: return Flags();
                ...
                case RegisterType::SP: return StackPointer();
                case RegisterType::PC: return ProgramCounter();
                default: return 0xFF;
            }
        }
        ...
        void SetHalfCarryFlag(const bool b) { b ? SetHalfCarryFlag() : ClearHalfCarryFlag(); }
...
constexpr const char* RegisterTypeToString(RegisterType type) {
    switch (type) {
        case RegisterType::NONE: return "NONE";
        case RegisterType::AF: return "AF";
        case RegisterType::BC: return "BC";
        case RegisterType::DE: return "DE";
        case RegisterType::HL: return "HL";
